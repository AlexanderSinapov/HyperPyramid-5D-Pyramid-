...
namespace HyperPyramid
{
    internal class Program
    {
        ...
        {
            Raylib.InitWindow(800, 600, "Hyper Pyramid");
        ...
        static void DrawTesseract()
        {
            ...
            for (int i = 0; i < v.Length; i++)
            {
                ...
                Raylib.DrawCircle(400, 10, 4, Color.White);
                ...
                for (int j = 0; j < 4; j++)
                {
                    ...
                    if (i < adjacentVertexIndex)
                    {
                        ...
                        Raylib.DrawLine(400, 10, adjacentScreenX, adjacentScreenY, Color.Blue);
                    }
                }
            }
